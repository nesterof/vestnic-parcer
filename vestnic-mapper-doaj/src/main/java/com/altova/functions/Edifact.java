  ...
  public static String autoformat( String sValue, String sFormat ) {
	...
	switch( Integer.parseInt(sFormat) )
	{
		...
		case 600:
		{
			...
			DateTime date = new DateTime( Y2KConvert.Year( century, 0 ), 1, 1 );
		...
		case 603:
		{
			...
			DateTime date;
			result = CoreTypes.formatNumber(Y2KConvert.Year( yy ), 4) + "-" + CoreTypes.formatNumber((semester - 1) * 6 + 1, 2) + "-01";
		}
			break;
		...
		case 604:
		{
			...
			int yy = Integer.parseInt( new String( arrValue, i, 2 ) );	i += 2;
			int semester  = Integer.parseInt( new String( arrValue, i, 1 ) );	i += 1;
			result = CoreTypes.formatNumber(Y2KConvert.Year( cc, yy ), 4) + "-" + CoreTypes.formatNumber((semester - 1) * 6 + 1, 2) + "-01";
		}
			break;
		...
		case 608:
		{
			...
			DateTime date = new DateTime( Y2KConvert.Year( cc, yy ), quarter, 1 );
		...
		case 613:
		{
			...
			if ( period != 0 )
				period = ( period * 10 ) -1;	
			DateTime date = new DateTime( Y2KConvert.Year( yy ), mm, 1 );
			Duration dur = new Duration( 0, 0, period, 0, 0, 0, 0.0, false );
		...
		case 614:
		{
			...
			if ( period != 0 )
				period = ( period * 10 ) -1;	
			DateTime date = new DateTime( Y2KConvert.Year( cc, yy ), mm, 1 );
			Duration dur = new Duration( 0, 0, period, 0, 0, 0, 0.0, false );
			date = Lang.datetimeAdd( date, dur );
			result = date.toDateString();
		}
		...
		case 814:
		{
			int nWorkingDays = Integer.parseInt( sValue );
			Duration dur = new Duration( 0, 0, nWorkingDays, 0, 0, 0, 0.0, false );
			result = dur.toString();
		}
			break;
  ...
  private static DateTime toDate( String sValue, String sFormat, boolean bRaiseExc ) {
	...
	switch( Integer.parseInt(sFormat) )
	{
		...
		case 103:
		{
			...
			DateTime baseDate = new DateTime( Y2KConvert.Year( year ), 1, 1 ); // 1st Jan.
			Duration days = new Duration( 0, 0, (week-1) * 7, 0, 0, 0, 0.0, false );
			DateTime date = Lang.datetimeAdd( baseDate, days );
			Duration oneWeek = new Duration( 0, 0, 7, 0, 0, 0, 0.0, false );
			int weekNumber = 0;
			do
			{
			...
			Duration dayOffset = new Duration( 0, 0, 0, 0, 0, 0, 0.0, false );
			int weekDay = Lang.weekday( date );
			date = Lang.datetimeAdd( date, (new Duration( 0, 0, weekDay-1, 0, 0, 0, 0.0, true ) ) );
			date = Lang.datetimeAdd( date, (new Duration( 0, 0, day-1, 0, 0, 0, 0.0, false ) ) );
			result = date;
		}
			break;
		...
		case 616:
		{
			...
			year = Integer.parseInt( new String( arrValue, i, 2 ) );  i += 2;
			week = Integer.parseInt( new String( arrValue, i, 2 ) );  i += 2;
			DateTime baseDate = new DateTime( Y2KConvert.Year( century, year ), 1, 1 ); // January 1st
			Duration days = new Duration( 0, 0, (week-1) * 7, 0, 0, 0, 0.0, false );
			result = Lang.datetimeAdd( baseDate, days );
		}
			break;
  ...
  private static Duration toDuration( String sValue, String sFormat, boolean bRaiseExc )
  {
	...
	switch( Integer.parseInt(sFormat) )
	{
		...
		case 701:
		{
			...
			result = new Duration( fromY < toY ? toY-fromY : fromY-toY, 0, 0, 0, 0, 0, 0.0, fromY > toY );
		}
			break;
		...
		case 702:
		{
			...
			result = new Duration( from < to ? to-from : from-to, 0, 0, 0, 0, 0, 0.0, from > to );
		}
			break;
		...
		case 709:
		{
			...
			int toY = Integer.parseInt( new String( arrValue, i, 2 ) );	i += 2;
			int toM = Integer.parseInt( new String( arrValue, i, 2 ) );	i += 2;
			DateTime from = new DateTime( Y2KConvert.Year( fromY ), fromM, 1, 0, 0, 0, 0.0 );
			DateTime to	= new DateTime( Y2KConvert.Year( toY ), toM, 1, 0, 0, 0, 0.0 );
			result = Lang.datetimeDiff( to, from );
		}
			break;
		...
		case 710:
		{
			...
			int toY = Integer.parseInt( new String( arrValue, i, 2 ) );	i += 2;
			int toM = Integer.parseInt( new String( arrValue, i, 2 ) );	i += 2;
			DateTime from = new DateTime( Y2KConvert.Year( fromC, fromY ), fromM, 1, 0, 0, 0, 0.0 );
			DateTime to	= new DateTime( Y2KConvert.Year( toC, toY ), toM, 1, 0, 0, 0, 0.0 );
			result = Lang.datetimeDiff( to, from );
		}
			break;
		...
		case 801:
		{
			...
			result = new Duration( year, 0, 0, 0, 0, 0, 0.0, false );
		}
			break;
		...
		case 802:
		{
			...
			result = new Duration( 0, month, 0, 0, 0, 0, 0.0, false );
		}
			break;
		...
		case 803:
		{
			...
			result = new Duration( 0, 0, week * 7, 0, 0, 0, 0.0, false );
		}
			break;
		...
		case 804:
		{
			...
			result = new Duration( 0, 0, day, 0, 0, 0, 0.0, false );
		}
			break;
		...
		case 805:
		{
			...
			result = new Duration( 0, 0, 0, hour, 0, 0, 0.0, false );
		}
			break;
		...
		case 806:
		{
			...
			result = new Duration( 0, 0, 0, 0, minute, 0, 0.0, false );
		}
			break;
		...
		case 807:
		{
			...
			result = new Duration( 0, 0, 0, 0, 0, seconds, 0.0, false );
		}
			break;
		...
		case 808:
		{
			...
			result = new Duration( 0, semester * 6, 0, 0, 0, 0, 0.0, false );
		}
			break;
		...
		case 809:
		{
			...
			result = new Duration( 0, fourMonth * 4, 0, 0, 0, 0, 0.0, false );
		}
			break;
		...
		case 810:
		{
			...
			result = new Duration( 0, trimester * 3, 0, 0, 0, 0, 0.0, false );
		}
			break;
		...
		case 811:
		{
			...
			result = new Duration( 0, 0, halfMonth * 15, 0, 0, 0, 0.0, false );
		}
			break;
		...
		case 812:
		{
			...
			result = new Duration( 0, 0, tenDays * 10, 0, 0, 0, 0.0, false );
		}
			break;
