...
public class MappingFrame extends JFrame implements com.altova.TraceTarget {
	...
	JLabel jic_importLabel1 = new JLabel();
	JTextField jic_importTextField1 = new JTextField();
	...
	protected void fillScrollPane() {
		...
		jName25420429_2017_17_3_unicodeTextField0.setText("C:/Users/test-1/Desktop/18.02.IC/2015.1.xml");
		...
		jic_importLabel1.setText("Instance of ic_import.xsd:");
		jic_importLabel1.setBounds(new Rectangle(15, 60, 438, 23));
		jPanelStructures.add(jic_importLabel1, null);
		jic_importTextField1.setText("C:/Users/test-1/Desktop/ic-import/ic-import.xml");
		jic_importTextField1.setBounds(new Rectangle(15, 85, 438, 23));
		jic_importTextField1.setEditable(false);
		jPanelStructures.add(jic_importTextField1, null);
