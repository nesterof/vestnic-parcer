...
public class MappingFrame extends JFrame implements com.altova.TraceTarget {
	...
	JLabel jName25420429_2017_17_3_unicode2Label0 = new JLabel();
	JTextField jName25420429_2017_17_3_unicode2TextField0 = new JTextField();

	JLabel jdoajArticles2Label1 = new JLabel();
	JTextField jdoajArticles2TextField1 = new JTextField();
	...
	private void jbInit() throws Exception {
		jInfoLabel1.setText("THIS APPLICATION WAS GENERATED BY MapForce 2018sp1");
	...
	protected void fillScrollPane() {
		...
		jName25420429_2017_17_3_unicode2Label0.setText("Source instance of 25420429_2017_17_3_unicode.xsd:");
		jName25420429_2017_17_3_unicode2Label0.setBounds(new Rectangle(15, 10, 438, 23));
		jPanelStructures.add(jName25420429_2017_17_3_unicode2Label0, null);
		jName25420429_2017_17_3_unicode2TextField0.setText("../../Downloads/351416---25420429_2017_17_3/25420429_2017_17_3_unicode.xml");
		jName25420429_2017_17_3_unicode2TextField0.setBounds(new Rectangle(15, 35, 438, 23));
		jName25420429_2017_17_3_unicode2TextField0.setEditable(false);
		jPanelStructures.add(jName25420429_2017_17_3_unicode2TextField0, null);

		jdoajArticles2Label1.setText("Instance of doajArticles.xsd:");
		jdoajArticles2Label1.setBounds(new Rectangle(15, 60, 438, 23));
		jPanelStructures.add(jdoajArticles2Label1, null);
		jdoajArticles2TextField1.setText("../../Downloads/doajArticles.xml");
		jdoajArticles2TextField1.setBounds(new Rectangle(15, 85, 438, 23));
		jdoajArticles2TextField1.setEditable(false);
		jPanelStructures.add(jdoajArticles2TextField1, null);
    ...
    void jStartButton_actionPerformed(ActionEvent e) {
		if (e.getSource().equals(jStartButton)) {
			...
			{
				com.altova.io.Input Name25420429_2017_17_3_unicode2Source = com.altova.io.StreamInput.createInput("../../Downloads/351416---25420429_2017_17_3/25420429_2017_17_3_unicode.xml");
				com.altova.io.Output doajArticles2Target = new com.altova.io.FileOutput("../../Downloads/doajArticles.xml");
